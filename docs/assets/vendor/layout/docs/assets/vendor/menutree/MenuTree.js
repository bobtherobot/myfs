...
console.log("openLeaf", scrollIntoView);
		if(andSelect){
		...
		if(list && list.length){
			...
			for (var i=0; i<list.length; i++){
				...
				if(hasKids){
					...
					itemOpenerElem.addEventListener("click", (function(thatMiid){ return function(){ toggle(thatMiid) } }(miid)), false);
				...
				itemSpan.addEventListener("click", (function(thatMiid){ return function(){ select(thatMiid) } }(miid)), false);
